<template>
  <div class="p-insure-container">
    ...
    <div class="c-group-container">
      ...
      <x-radio :option-list="genderList" v-model="gender" title="性别" />
      <x-input
        title="手机号码"
        name="mobile"
        v-model="mobile"
    ...
    <div class="c-group-container">
      ...
      <template v-if="relation === '1'">
        <x-cell title="姓名" :value="name" />
        <x-cell title="证件类型" value="身份证" />
        <x-cell title="证件号码" :value="cardNo" />
        <x-cell title="出生日期" :value="birthday" />
        <x-cell title="性别" :value="gender | genderFilter" />
        <x-cell title="手机号码" :value="mobile" />
        <x-cell title="邮箱" :value="email" />
      </template>
      <template v-else>
        <x-input
          title="被保人姓名"
          ...
          :max="20"
        />
        <x-cell title="证件类型" name="cardType2" value="身份证" />
        <x-input
          title="身份证号码"
          name="cardNo2"
        ...
        <x-radio :option-list="genderList" v-model="gender2" title="性别" />
        <x-input
          title="手机号码"
          name="mobile"
      ...
      <x-radio :option-list="socialList" v-model="social" title="有无社保" />
    </div>
    ...
    <div class="c-group-container">
      ...
      <x-cell :disabled="true" title="受益人类型" value="法定受益人" />
    </div>
...
export default {
  data() {
    return {
      genderList: [{ name: "男", value: "Y" }, { name: "女", value: "N" }],
      socialList: [
        { name: "有社保", value: "Y" },
        { name: "无社保", value: "N" }
      ],
...
.p-insure-container {
  ...
  .c-navbar {
    ...
    height: 50px;
    background: #fff;
    box-shadow: 1px 5px 20px 0 rgba(186, 212, 247, 0.5);
    .left-btn,
    .right-btn {
      flex: 1;
      height: 50px;
